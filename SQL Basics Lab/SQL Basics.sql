...
-- EXERCISE
-- Update all values for `fare_amount` where the pickup zipcode equals `10023`
UPDATE ...

-- EXERCISE
-- Cleanup: delete the table you just created
-- Hint: use the `DROP TABLE` command
